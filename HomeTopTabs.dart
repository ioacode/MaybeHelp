...
import 'package:test_helloworld/controller/navigations/nestleTab/HomeForYouTabs.dart';
      ...
      child: Scaffold(
          ...
          bottom: TabBar(
            ...
            tabs: <Widget>[
              ...
              Tab(
                ...
                ? Color(widget.colorVal)
                : Colors.white),
                child: Text('Easy Access', style: TextStyle(color: _tabController.index == 4
                ? Color(widget.colorVal)
                : Colors.white
                )),
              ),
        ...
        body: TabBarView(
          ...
          children: <Widget>[
            ...
            Container(
              height: 200.0,
              child: Center(child: Text('Tops Chat')),
            ),
            Container(
              height: 200.0,
            ...
            Container(
              height: 200.0,
              child: Center(child: Text('Easy Access')),
            ),
            Container(
              height: 200.0,
              child: Center(child: Text('Editors choice')),
            )
